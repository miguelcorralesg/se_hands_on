...
1. Create a python virtual environment and activate it:
   ...
   > **Note:** Use Python 3.11 or 3.12. Python 3.13+ is not yet fully supported by native packages like `faiss-cpu` and `unstructured` and may cause hard crashes.
   > If needed, install a compatible version first:
   > - **macOS:** `brew install python@3.11`
   > - **Ubuntu/Debian:** `sudo apt install python3.11` 

   ```console
   python3.11 -m venv genai
